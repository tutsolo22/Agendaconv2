<x-layouts.app>
    ...
    <div class="card">
        <div class="card-header bg-white border-bottom-0 pt-3">
            <form action="{{ route('tenant.facturacion.cfdis.index') }}" method="GET">
                <div class="input-group">
                    <input type="text" class="form-control" name="search_serie" placeholder="Buscar por Serie..." value="{{ request('search_serie') }}">
                    <input type="text" class="form-control" name="search_folio" placeholder="Buscar por Folio..." value="{{ request('search_folio') }}">
                    <button class="btn btn-primary" type="submit" title="Buscar">
                        <i class="fa-solid fa-search"></i>
                    </button>
                    <a href="{{ route('tenant.facturacion.cfdis.index') }}" class="btn btn-secondary" title="Limpiar búsqueda"><i class="fa-solid fa-eraser"></i></a>
                </div>
            </form>
        </div>
                                ...
                                <td class="text-end">
                                    ...
                                    @if($factura->status === 'timbrado')
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('tenant.facturacion.cfdis.create-credit-note', $factura) }}" class="btn btn-sm btn-outline-primary" title="Crear Nota de Crédito (Egreso)">
        ...
        @if ($facturas->hasPages())
            <div class="card-footer">
                {{-- Se usa appends para que la paginación mantenga los filtros de búsqueda --}}
